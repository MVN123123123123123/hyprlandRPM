%global commit0 4e397a4e5a703fc2f905b73eb60e0a772654317b
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:           linux-cachyos-rt-bore-x86-64-v4
Version:        7.1.3
Release:        202607190236%{?dist}
...
%description
Linux kernel with CachyOS patches, BORE scheduler, and RT preempt, optimized for x86-64-v4.
...
if [ -x /usr/sbin/grubby ]; then
    /usr/sbin/grubby --add-kernel=/boot/vmlinuz-${KVER} --title="CachyOS RT BORE x86-64-v4" --initrd=/boot/initramfs-${KVER}.img
fi
