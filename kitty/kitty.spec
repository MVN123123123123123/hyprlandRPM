...
# Vendored Go dependencies generated by bundle_go_deps_for_rpm.sh
Source4:        vendor-%{version}.tar.gz
...
# Extract vendor tarball generated by bundle_go_deps_for_rpm.sh
tar xvf %{SOURCE4}
